...
flags.DEFINE_string("checkpoint_dir", "./checkpoints/NYU_fresh", "Directory name to save the checkpoints")   
...
flags.DEFINE_integer("summary_freq", 2500, "Logging every log_freq iterations")
